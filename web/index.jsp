...
<header>
    <div id="logo_home">
        <h1><a href="index.html" title="Quote">TEST'e BAŞLA</a></h1>
    </div>
    ...
    <nav class="main_nav">
        <ul class="nav nav-tabs">
            <li><a href="#tab_1" data-toggle="tab">Test'e başla</a></li>
...
<div class="intro_txt animated fadeInUp">
    <h2>Mobbing Nedir?</h2>
    <p> Türk Dil Kurumu'na göre Mobbing in sözlük anlamı "BEZDIRMEK" olarak tanımlnamıştır  daha fazlasını ögrenmek için test başlayınız! </p>

    <div class="row justify-content-md-center">
        <nav class="btn_nav">
            <ul class="nav nav-tabs">
                <li><a href="#tab_1"  class="btn btn-lg btn-primary" data-toggle="tab">TEST'E BAŞLA</a></li>
                ...
                <div class="tab-pane fade" id="tab_1">
                    ...
                    <div class="row">
                        <aside class="col-xl-3 col-lg-4">
                            <h2>Mobbing'e uğruyormusunuz yoksa uğramıyor musunuz bunu öğrenmek için testi çözünüz!</h2>
                            <p class="lead">Bu test ip bilginiz dışında hiçbir kişisel veriyi kayıt altına almaz</p>
                            <ul class="list_ok">
                                <li>Soruları çözün</li>
                                <li>Mobbing uğrayıyor iseniz istatistik oranlarıyla mahkemede kazanma oranızı  tahmin ediyoruz </li>
                                <li>Daha fazla bilgi için 1. testi bitiriniz ve 2. test geçiniz</li>
                            </ul>
                        </aside><!-- /aside -->
