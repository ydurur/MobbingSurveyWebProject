(function ($) {
	...
	var $MainBtn = $('.main_nav1 .nav-tabs a');
 ...
 var callRestService = function (e) {

     $.ajax({
         url: '//178.62.37.41:9091/token',
         dataType: 'json',
         type: 'POST',
         ...
         success: function( data, textStatus, response ){
         	alert("oldu");
         	alert(response.getResponseHeader('sid'));
             console.log(response.getResponseHeader("Header"));
         },
